...
namespace jp.illusive_isc.MizukiOptimizer
{
    ...
    public class IllMizukiOptimizer : MonoBehaviour, IEditorOnly
    {
        ...
        private ParamProcessConfig[] GetParamConfigs(VRCAvatarDescriptor descriptor)
        {
            return new ParamProcessConfig[]
            {
                ...
                {
                    condition = () => true,
                    processAction = () => ProcessParam<IllMizukiParamDef>(descriptor),
                },
                new()
                {
                    condition = () => petFlg,
                    processAction = () => ProcessParam<IllMizukiParamPet>(descriptor),
                },
                new()
                {
                    condition = () => TailFlg,
                    processAction = () => ProcessParam<IllMizukiParamTail>(descriptor),
                    afterAction = () =>
                    {
                        if (TailFlg1)
                ...
                {
                    condition = () => ClothFlg,
                    processAction = () => ProcessParam<IllMizukiParamCloth>(descriptor),
                },
                new()
                {
                    condition = () => HairFlg,
                    processAction = () => ProcessParam<IllMizukiParamHair>(descriptor),
                    afterAction = () =>
                    {
                ...
                {
                    condition = () => TPSFlg,
                    processAction = () => ProcessParam<IllMizukiParamTPS>(descriptor),
                },
                new()
                {
                    condition = () => ClairvoyanceFlg,
                    processAction = () => ProcessParam<IllMizukiParamClairvoyance>(descriptor),
                },
                new()
                {
                    condition = () => colliderJumpFlg,
                    processAction = () => ProcessParam<IllMizukiParamCollider>(descriptor),
                },
                new()
                {
                    condition = () => pictureFlg,
                    processAction = () => ProcessParam<IllMizukiParamPicture>(descriptor),
                },
                new()
                {
                    condition = () => BreastSizeFlg,
                    processAction = () => ProcessParam<IllMizukiParamBreastSize>(descriptor),
                },
                new()
                {
                    condition = () => LightGunFlg,
                    processAction = () => ProcessParam<IllMizukiParamLightGun>(descriptor),
                },
                new()
                {
                    condition = () => WhiteBreathFlg,
                    processAction = () => ProcessParam<IllMizukiParamWhiteBreath>(descriptor),
                },
                new()
                {
                ...
                new()
                {
                    ...
                    processAction = () => ProcessParam<IllMizukiParam8bit>(descriptor),
                },
                new()
                {
                    condition = () => HeartGunFlg,
                    processAction = () => ProcessParam<IllMizukiParamHeartGun>(descriptor),
                },
                new()
                {
                    condition = () => PenCtrlFlg,
                    processAction = () => ProcessParam<IllMizukiParamPenCtrl>(descriptor),
                },
                new()
                {
                    condition = () => FaceGestureFlg || FaceLockFlg || FaceValFlg,
                    processAction = () => ProcessParam<IllMizukiParamFaceGesture>(descriptor),
                },
                new()
                {
                    condition = () => kamitukiFlg || nadeFlg || blinkFlg,
                    processAction = () => ProcessParam<IllMizukiParamFaceContact>(descriptor),
                },
            };
        }
