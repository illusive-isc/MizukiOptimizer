...
namespace jp.illusive_isc.MizukiOptimizer
{
    ...
    internal class EightBit : Utils
    {
        ...
        public EightBit Initialize(VRCAvatarDescriptor descriptor, AnimatorController animator)
        {
        ...
        public EightBit DeleteVRCExpressions(VRCExpressionsMenu menu, VRCExpressionParameters param)
        {
