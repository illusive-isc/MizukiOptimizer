...
{
    [AddComponentMenu("")]
    internal class IllMizukiParamFaceGesture : IllMizukiUtils
    {
        ...
        public IllMizukiParamFaceGesture Initialize(
            VRCAvatarDescriptor descriptor,
            AnimatorController animator,
        ...
        public IllMizukiParamFaceGesture DeleteFx()
        {
        ...
        public IllMizukiParamFaceGesture DeleteParam()
        {
            if (FaceGestureFlg || FaceValFlg)
        ...
        public IllMizukiParamFaceGesture DeleteVRCExpressions(
