...
{
    internal class IllMizukiParamHair : IllMizukiParam
    {
        ...
        public IllMizukiParamHair Initialize(
            VRCAvatarDescriptor descriptor,
            AnimatorController animator,
        ...
        public IllMizukiParamHair DeleteFxBT()
        {
        ...
        public IllMizukiParamHair DeleteParam()
        {
        ...
        public IllMizukiParamHair DeleteVRCExpressions(
        ...
        public IllMizukiParamHair ChangeObj()
        {
            ...
            var headphone = descriptor.transform.Find(
                "Armature/Hips/Spine/Chest/Neck/Head/mizuki_headphone"
            );
            if (headphone)
                if (HairFlg5)
