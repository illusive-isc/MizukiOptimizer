...
namespace jp.illusive_isc.MizukiOptimizer
{
    internal class IllMizukiParamTail : IllMizukiParam
    {
        ...
        public IllMizukiParamTail Initialize(
            VRCAvatarDescriptor descriptor,
            AnimatorController animator
        )
        {
        ...
        public IllMizukiParamTail DeleteFxBT()
        {
        ...
        public IllMizukiParamTail DeleteParam()
        {
        ...
        public IllMizukiParamTail DestroyObj(bool clothFlg1, bool clothFlg2)
        {
